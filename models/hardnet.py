...
class Bootstrapped_CrossEntropy2d(nn.Module):
    def __init__(self, K, thresh, weight, size_average):
        super().__init__()
    # (min_K, loss_th, weight=None, size_average=True):
        self.min_K =K
        self.thresh = thresh
        self.weight = weight
        self.size_average = size_average

    def _bootstrap_xentropy_single(self, input, target, thresh, weight=None, size_average=True):
        ...
        if sorted_loss[self.min_K] > self.thresh:
